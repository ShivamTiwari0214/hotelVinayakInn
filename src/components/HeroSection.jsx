...
const HeroSection = () => {
  return (
    <div id='hero' className='text-center pt-8 px-6'>
        <h3 className='mb-[-10px] text-sm sm:text-[2vw]'> <span className='font-poppins'>Unforgettable stays during </span> <span className='text-[#E07100] font-preahvihear font-regular'>महाकुंभ</span></h3>
